    ...
    <>
      <div className="bg-white justify-center items-center px-6 pb-8 pt-[82px]">
        <div className=" sm:text-left lg:mx-[21px] sm:p-12">
          <h1 className="text-[50px] font-semibold md:text-center mb-[108px] md:mb-[72px]">
            How it Works
          </h1>
          <p className="mt-4 text-mygray-120 text-lg">
          ...
          <div className="mt-[86px]">
            ...
            <p className="mt-10 text-mygray-120 text-lg font-medium">
          ...
          <div className="mt-12 mb-12">
            <h2 className=" text-[28px] items-center font-semibold  md:text-center md:t">
