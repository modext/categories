            ...
            <div className="bg-white">
                <div className=" mx-auto md:p-[93px] p-6 sm:p-12">
                    ...
                    <div className="lg:flex lg:justify-between ">
                        ...
                        <div className="flex justify-center   rounded-sm md:rounded-md  lg:h-[535px] my-[66px]">
                            <Image
                                src="/images/chattingPeople.png"
                                alt="Team"
                                width={0}
                                height={0}
                                sizes="100vw"
